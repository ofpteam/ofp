...
CREATE TABLE `product` (
  ...
  `VAT_RATE` decimal(10,0) DEFAULT NULL COMMENT '增值税率',
  ...
  `LENGTH` decimal(10,0) DEFAULT NULL COMMENT '外包装长度（单位:cm）',
  `WIDTH` decimal(10,0) DEFAULT NULL COMMENT '外包装宽度（单位：cm）',
  `PACK_HEIGHT` decimal(10,0) DEFAULT NULL COMMENT '外包装高度（单位：cm）',
  `GW` decimal(10,0) DEFAULT NULL COMMENT 'GW',
  `PACKING_RATE` decimal(10,0) DEFAULT NULL COMMENT '装箱率',
  `TAX_REBATE_RATE` decimal(10,0) DEFAULT NULL COMMENT '退税率',
  `CBM` decimal(10,0) DEFAULT NULL COMMENT 'CBM',
...
CREATE TABLE `quotation_sheet` (
  ...
  `EXCHANGE_RATE` decimal(10,0) DEFAULT NULL COMMENT '汇率',
  `EXPIRATION_DATE` datetime DEFAULT NULL COMMENT '有效期限',
  ...
  `DELIVERY_DATE` datetime DEFAULT NULL COMMENT '交货期限',
  `INSURANCE_COST` decimal(10,0) DEFAULT NULL COMMENT '保险费',
  `FOREIGN_GREIGHT` decimal(10,0) DEFAULT NULL COMMENT '国外运费',
  `HOME_GREIGHT` decimal(10,0) DEFAULT NULL COMMENT '国内运费',
  `OPERATION_COST` decimal(10,0) DEFAULT NULL COMMENT '管理费',
  `COMMISSION` decimal(10,0) DEFAULT NULL COMMENT '佣金',
  `REBATE` decimal(10,0) DEFAULT NULL COMMENT '折扣',
  `TOTAL_CBM` decimal(10,0) DEFAULT NULL COMMENT 'CBM合计',
  `PROFIT` decimal(10,0) DEFAULT NULL COMMENT '利润',
  `SWAP_RATE` decimal(10,0) DEFAULT NULL COMMENT '换汇率',
...
CREATE TABLE `quotation_sub_sheet` (
  ...
  `TOTALCBM` decimal(10,0) DEFAULT NULL COMMENT 'TOTALCBM',
  `GW` decimal(10,0) DEFAULT NULL COMMENT 'GW',
  `TOTAL_GW` decimal(10,0) DEFAULT NULL COMMENT '总毛重',
  PRIMARY KEY (`QUOTATION_SUB_SHEET`),
