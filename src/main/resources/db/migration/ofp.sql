...
CREATE TABLE `interest_rate` (
  ...
  `RATE` decimal(10,4) DEFAULT NULL COMMENT '利率,算利息的',
...
CREATE TABLE `product` (
  ...
  `TOP` decimal(10,2) DEFAULT NULL COMMENT 'TOP（单位：mm）',
  `BOTTOM` decimal(10,2) DEFAULT NULL COMMENT 'BOTTOM（单位：mm）',
  `HEIGHT` decimal(10,2) DEFAULT NULL COMMENT 'HEIGHT(单位：mm)',
